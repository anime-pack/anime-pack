...
export default function SearchBar() {
    ...
    return (
        <div
            className="flex relative items-center justify-center max-w-[64%] min-w-[107px] w-[10%] focus-within:w-full focus-within:h-[65%] ease-in-out transition-all duration-500 right-4 has-[input:not(:placeholder-shown)]:w-full"
        >
            <Input
                value={searchValue}
                placeholder="Ctrl + K"
